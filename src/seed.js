export function dDatabase(firebase) {
    function getUUID() {
    ...
    firebase.firestore().collection('series').add({
      ...
      title: 'Super Size Me',
      description:
        "Director Morgan Spurlock's social experiment in fast-food gastronomy s him attempting to subsist uniquely on food from the McDonalds",
      genre: 'documentaries',
      maturity: '12',
      slug: 'super-size-me',
    });
    ...
    firebase.firestore().collection('films').add({
      ...
      title: 'Despicable Me',
      description:
        'Gru, a criminal mastermind, adopts three orphans as pawns to carry out the biggest heist in history. His life takes an unexpected turn when the little girls  him as their potential father.',
      genre: 'children',
      maturity: '0',
      slug: 'despicable-me',
    });
    ...
    firebase.firestore().collection('films').add({
      ...
      title: 'Spirited Away',
      description:
        'In this animated feature by noted Japanese director Hayao Miyazaki, 10-year-old Chihiro (Rumi Hiiragi) and her parents (Takashi Naitô, Yasuko Sawaguchi) stumble upon a mingly abandoned amusement park.',
      genre: 'children',
      maturity: '0',
      slug: 'spirited-away',
    });
    ...
    firebase.firestore().collection('films').add({
      ...
      title: 'Joker',
      description:
        'Forever alone in a crowd, failed comedian Arthur Fleck ks connection as he walks the streets of Gotham City.',
      genre: 'thriller',
      maturity: '15',
      slug: 'joker',
    });
    ...
    firebase.firestore().collection('films').add({
      ...
      description:
        'Clarice Starling, an FBI agent, ks help from Hannibal Lecter, a psychopathic serial killer and former psychiatrist, in order to apprehend another serial killer who has been claiming female victims.',
      genre: 'thriller',
      maturity: '15',
